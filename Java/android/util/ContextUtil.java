...
public class ContextUtil {
	...
	public static String getUUID(Context context) {
		...
		String sgSerial;
		if (checkPermission(context, Manifest.permission.READ_PHONE_STATE)) {
			sgDevice = COMPANY_NAME + invokeTelephonyManagerMethod("getDeviceId", context);
			sgSerial = COMPANY_NAME + invokeTelephonyManagerMethod("getSimSerialNumber", context);
		} else {
			sgDevice = COMPANY_NAME;
			sgSerial = COMPANY_NAME;
		}
		return new UUID((long) (COMPANY_NAME + Settings.Secure.getString(context.getContentResolver(), "android_id"))
